...
<x-filament::widget>
    <div class="mb-10 text-center">
        <div class="flex flex-col items-center gap-3">
            ...
            <span class="text-3xl font-extrabold bg-gradient-to-r from-amber-500 to-yellow-400 bg-clip-text text-transparent">Leave Requests Summary</span>
        </div>
        <div class="mt-2 text-base text-gray-500">Pending, approved, and rejected leave requests.</div>
    </div>
    <style>
        .custom-stat-card {
        ...
        .stat-leave-bg-1 { background: linear-gradient(135deg, #f59e42 0%, #fbbf24 100%); }
        .stat-leave-bg-2 { background: linear-gradient(135deg, #22d3ee 0%, #0ea5e9 100%); }
        .stat-leave-bg-3 { background: linear-gradient(135deg, #f43f5e 0%, #f59e42 100%); }
        .custom-stat-label {
            font-size: 1.1rem;
            font-weight: 700;
