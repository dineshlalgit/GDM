...
<x-filament::widget>
    <div class="mb-10 text-center">
        <div class="flex flex-col items-center gap-3">
            ...
            <span class="text-3xl font-extrabold bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent">Storage Usage Overview</span>
        </div>
        <div class="mt-2 text-base text-gray-500">Total storage, files, and average per user.</div>
    </div>
    <style>
        .custom-stat-card {
        ...
        .stat-storage-bg-1 { background: linear-gradient(135deg, #0ea5e9 0%, #22d3ee 100%); }
        .stat-storage-bg-2 { background: linear-gradient(135deg, #f59e42 0%, #f43f5e 100%); }
