...
<x-filament::widget>
    <div class="mb-10 text-center">
        <div class="flex flex-col items-center gap-3">
            ...
            <span class="text-3xl font-extrabold bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent">User Stats Overview</span>
        </div>
        <div class="mt-2 text-base text-gray-500">Total, active, and suspended users.</div>
    </div>
    <style>
        .custom-stat-card {
        ...
        .stat-user-bg-1 { background: linear-gradient(135deg, #3b82f6 0%, #10b981 100%); }
